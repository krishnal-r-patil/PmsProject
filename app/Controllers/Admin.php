...
class Admin extends BaseController
{
    ...
    public function categories()
    {
        ...
        // --- On-Demand Migration ---
        $db->query("CREATE TABLE IF NOT EXISTS service_categories (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        $count = $db->table('service_categories')->countAllResults();
        if ($count == 0) {
            $defaults = [
                ['name' => 'Birth Certificate', 'prefix' => 'BRT', 'description' => 'Official registration of birth within Panchayat limits.', 'processing_days' => 7, 'fees' => 20.00],
                ['name' => 'Death Certificate', 'prefix' => 'DTH', 'description' => 'Official record of death for legal and inheritance purposes.', 'processing_days' => 7, 'fees' => 20.00],
                ['name' => 'Income Certificate', 'prefix' => 'INC', 'description' => 'Verification of annual household income for scholarship/subsidy.', 'processing_days' => 3, 'fees' => 50.00],
                ['name' => 'Caste Certificate', 'prefix' => 'CST', 'description' => 'Official proof of social category (SC/ST/OBC).', 'processing_days' => 15, 'fees' => 30.00],
                ['name' => 'Domicile Certificate', 'prefix' => 'DOM', 'description' => 'Proof of residence within the state/village area.', 'processing_days' => 10, 'fees' => 40.00],
            ];
            $db->table('service_categories')->insertBatch($defaults);
        }
