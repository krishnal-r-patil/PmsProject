...
<body>
                        ...
                        <div id="income-only" style="display: none;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="data[profession]" placeholder="e.g. Farmer, Shopkeeper" required>
                                </div>
                                <div class="form-group">
                                    <label>Annual Income (₹) *</label>
                                    <input type="number" name="data[annual_income]" placeholder="Total household income" required>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function toggleFormHelp(val) {
            ...
            document.getElementById('income-only').style.display = (val === 'Income Certificate') ? 'block' : 'none';
